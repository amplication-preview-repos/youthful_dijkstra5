...
@InputType()
class AssignmentCreateNestedManyWithoutCoursesInput {
...
export { AssignmentCreateNestedManyWithoutCoursesInput as AssignmentCreateNestedManyWithoutCoursesInput };
