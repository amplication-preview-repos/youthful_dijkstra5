...
@InputType()
class StudentCreateNestedManyWithoutDepartmentsInput {
...
export { StudentCreateNestedManyWithoutDepartmentsInput as StudentCreateNestedManyWithoutDepartmentsInput };
