...
@InputType()
class TeacherCreateNestedManyWithoutDepartmentsInput {
...
export { TeacherCreateNestedManyWithoutDepartmentsInput as TeacherCreateNestedManyWithoutDepartmentsInput };
